...
CUDA_VISIBLE_DEVICES=0,1 CUDA_LAUNCH_BLOCKING=1 ~/.conda/envs/pytorch_transunet/bin/python -u '/lfs/usrhome/btech/ed17b047/transunet/TransUNet/train.py' --base_lr 0.02262 --dice_ce_split 2.5 >> $logfilename.log 2>> $logfilename.err