...
def test_func(args, sweep=False):
    ...
    snapshot_path = " ../../scratch/transunet/model/{}/{}".format(args.exp, 'TU')    
...
def inference(args, model, test_save_path=None):
    ...
    wandb.run.summary["test_dice"] = performance
    wandb.run.summary["test_hd"] = mean_hd95
